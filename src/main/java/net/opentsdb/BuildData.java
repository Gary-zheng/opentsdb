...
public final class BuildData {
  ...
  public static final String date = "2016/03/13 15:25:36 +0000";
  /** UNIX timestamp of the time of the build. */
  public static final long timestamp = 1457882736;
  ...
  public static final String host = "base.cos.com";
  /** Path to the repository in which this package was built. */
  public static final String repo = "/root/src/opentsdb-2.2.0/build";

  /** Human readable string describing the revision of this package. */
  public static final String revisionString() {
    return "net.opentsdb.tools 2.2.0 built at revision  (MODIFIED)";
  }
  /** Human readable string describing the build information of this package. */
  public static final String buildString() {
    return "Built on 2016/03/13 15:25:36 +0000 by root@base.cos.com:/root/src/opentsdb-2.2.0/build";
  }
